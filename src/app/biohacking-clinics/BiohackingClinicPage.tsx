...
function SchemaMarkup() {
  const schema = {
    ...
    '@graph': [
      {
        '@type': 'Service',
        name: 'Web Design for Biohacking Studios & Performance Clinics',
        description:
        ...
        audience: {
          '@type': 'Audience',
          audienceType: 'Biohacking studio and performance clinic owners',
        },
      },
    ],
  };
...
function JotformEmbedCard() {
  ...
  useEffect(() => {
    ...
    script.src = 'https://form.jotform.com/jsform/261293298209060';
...
function HeroSection() {
  ...
  useEffect(() => {
    const t = setInterval(() => setActiveTag((i) => (i + 1) % STUDIO_TAGS.length), 2400);
    ...
    >
      ...
      <div className="relative z-10 flex-1 flex items-center w-full px-6 sm:px-10 lg:px-16 xl:px-20">
        ...
        <div>
          ...
          >
            Built for biohacking studios and performance optimization clinics.
          </motion.p>
...
function GapSection() {
  const inside = [
    ...
    'Neurofeedback stations',
    'Peptide protocols',
    'Wearable-based optimization',
    '$300–$1,500 sessions',
  ];
  const outside = [
    'Loads in 7 seconds',
    ...
    'Ranks on page 5',
    'Built on a generic template in 2019',
  ];
    ...
    <section id="mismatch" className="relative py-28 md:py-36 px-6 lg:px-12 bg-black border-t border-white/10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Reveal delay={0.2}>
          ...
          >
            &ldquo;That gap is costing you a booking every day.&rdquo;
          </p>
        </Reveal>
      </div>
    </section>
...
const REFERENCE_STUDIOS = [
  {
    name: 'Upgrade Labs',
    focus: 'Cryotherapy · biohacking tech',
    theme: 'Performance',
  },
  {
    name: 'Next Health',
    focus: 'NAD+ · peptides · optimization',
    theme: 'Biohacking',
  },
  {
    name: '40 Years of Zen',
    focus: 'Neurofeedback · brain training',
    theme: 'Neuroscience',
  },
  {
    name: 'IRIDIUM',
    focus: 'Wearables · data-driven health',
    theme: 'Quantified Self',
  },
];

function MockupCard({ name, focus, theme }: (typeof REFERENCE_STUDIOS)[0]) {
  return (
    <motion.div
    ...
    >
      <div className="mb-6 border border-white/10 bg-black/70">
        ...
        <div className="relative h-28 overflow-hidden p-4">
          ...
          />
          <div className="text-[9px] font-mono mb-3 leading-none" style={{ color: `${ACCENT}80` }}>
            {focus}
          </div>
          <div className="h-[2px] mb-2 rounded-full" style={{ width: '48px', backgroundColor: `${ACCENT}35` }} />
          <div className="h-[1px] mb-4 rounded-full" style={{ width: '32px', backgroundColor: 'rgba(255,255,255,0.12)' }} />
          <div className="h-[1px] mb-1 rounded-full" style={{ width: '80px', backgroundColor: 'rgba(255,255,255,0.06)' }} />
          <div className="h-[1px] rounded-full" style={{ width: '64px', backgroundColor: 'rgba(255,255,255,0.06)' }} />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-[1.2fr_1fr] gap-12 items-start mb-16">
          <Reveal>
            ...
            >
              The studios winning right now don&apos;t look like gyms. They
        ...
        <div className="grid sm:grid-cols-2 gap-px bg-white/10">
          {REFERENCE_STUDIOS.map((studio, i) => (
...
const DELIVERABLES = [
  {
    ...
    body: 'Hand-coded, sub-2-second load time, mobile-first, designed for memberships and session bookings. 14-day delivery.',
  },
  {
    n: '02',
    ...
    <section id="offer" className="relative py-28 md:py-36 px-6 lg:px-12 bg-[#0a0a0a] border-t border-white/10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
            ...
            <Reveal key={d.n} delay={i * 0.1}>
              <div className="bg-[#0a0a0a] hover:bg-[#0f0f0f] transition-colors h-full p-8 md:p-10">
                <div
                  ...
                  style={{ color: `${ACCENT}80`, fontVariantNumeric: 'tabular-nums' }}
                >
                  {d.n}
                </div>
                <h3
        ...
        <Reveal delay={0.2}>
          ...
          >
            &ldquo;Most studios see 2–3x more session bookings within 60 days.&rdquo;
          </p>
        </Reveal>
      </div>
    </section>
            ...
            <Reveal key={step.n} delay={i * 0.1}>
              ...
              >
                <div className="flex items-center gap-4 mb-8">
                  <span className="font-mono text-xs tracking-[0.3em]" style={{ color: ACCENT }}>
                    {step.n}
                  </span>
            ...
            <div className="md:sticky md:top-32">
              <Reveal>
                ...
                <p className="text-white/55 text-lg leading-relaxed max-w-sm mb-8">
                  The most common things biohacking studio owners ask before we
                  kick off.
                </p>
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="mt-24 pt-8 border-t border-white/10">
          <p className="text-[10px] font-mono uppercase tracking-[0.3em] text-white/30">
            Marc Friedman · Web Design for Biohacking Studios · {new Date().getFullYear()}
          </p>
        </div>
      </div>
    </section>
...
export default function BiohackingClinicPage() {
  return (
    <>
      <SchemaMarkup />
      <HeroSection />
